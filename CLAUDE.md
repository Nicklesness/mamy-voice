...
Мобильное веб-приложение для озвучки детских книг голосом матери. Мама записывает 1 пассаж текста (~30 сек), выбирает книгу — приложение генерирует аудиоверсию книги клонированным голосом через ElevenLabs API.
...
- **Deploy**: Railway (persistent disk для аудио)
